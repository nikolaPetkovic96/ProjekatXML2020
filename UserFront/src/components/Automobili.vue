    ...
    <div id="automobili-overview">
        ...
        <div class="container" id='main'>
            <table class="table">
                ...
                <tbody>
                    <tr v-bind:key='automobil.id' v-for="automobil in cars">
        ...
        // metoda za koja salje parametre za pretragu automobila i vraca listu automobila kao rezultat
         searchCar() {
            ...
            if (this.searchedCar.kilometraza !== null) {
             ...
             this.cars = this.automobili
             console.log("CARS == AUTOMOBILI")
            //Ovo obrisati
            console.log(`SearchedQuery : ${this.searchedQuery}`);
            UserDataService.searchCarsFiltered(this.searchedQuery).then(response => {
