...
--CommonData (Za TSlikaVozila)	19-21
INSERT INTO Common_data(datum_kreiranja, datum_izmene, korisnik_id)  VALUES('2017-10-01 21:58:58','2017-10-02 18:57:58',1)
INSERT INTO Common_data(datum_kreiranja, datum_izmene, korisnik_id)  VALUES('2018-02-20 21:58:58','2018-10-23 18:57:58',1)
INSERT INTO Common_data(datum_kreiranja, datum_izmene, korisnik_id)  VALUES('2019-11-04 21:58:58','2019-07-04 18:57:58',2)
...
-- Test users id: 1-3  
INSERT INTO tuser(korisnicko_ime, lozinka, email, adresa_id, status, ime, prezime, jmbg, pol, naziv, pib, common_data_id) VALUES ('Darkooo91', 'pass1', 'nmaster@gmail.com', 4, 'aktivan','Darko', 'Darkovic', '213123124','Muski',NULL, NULL, 24)
INSERT INTO tuser(korisnicko_ime, lozinka, email, adresa_id, status, ime, prezime, jmbg, pol, naziv, pib, common_data_id) VALUES ('Anna00', 'pass2', 'nmaster@gmail.com', 4, 'aktivan','Ana', 'Anic', '213123124','Zenski',NULL, NULL, 24)
INSERT INTO tuser(korisnicko_ime, lozinka, email, adresa_id, status, ime, prezime, jmbg, pol, naziv, pib, common_data_id) VALUES ('PeraCar996', 'pass2', 'nmaster@gmail.com', 4, 'aktivan','Petar', 'Petrovic', '213123124','Zenski',NULL, NULL, 24)
...
--CommonData (Za Komentare) id: 1 - 3
INSERT INTO Common_data(datum_kreiranja, datum_izmene, korisnik_id)  VALUES('2017-10-01 21:58:58','2017-10-02 18:57:58',1)
INSERT INTO Common_data(datum_kreiranja, datum_izmene, korisnik_id)  VALUES('2018-02-20 21:58:58','2018-10-23 18:57:58',2)
INSERT INTO Common_data(datum_kreiranja, datum_izmene, korisnik_id)  VALUES('2019-11-04 21:58:58','2019-07-04 18:57:58',3)

--CommonData (Za Ocene) id: 4 - 6
INSERT INTO Common_data(datum_kreiranja, datum_izmene, korisnik_id)  VALUES('2017-10-01 21:58:58','2017-10-02 18:57:58',1)
INSERT INTO Common_data(datum_kreiranja, datum_izmene, korisnik_id)  VALUES('2018-02-20 21:58:58','2018-10-23 18:57:58',2)
INSERT INTO Common_data(datum_kreiranja, datum_izmene, korisnik_id)  VALUES('2019-11-04 21:58:58','2019-07-04 18:57:58',3)
...
--CommonData (Za Rezervacija) id: 10

INSERT INTO Komentar(tekst_komentara, odobren, rezervacija_id, automobil_id, common_data_id) VALUES('Od Darkooo91 komentar neki  ocena 5! ', true, 1, 1, 1) --za porse 911
INSERT INTO Komentar(tekst_komentara, odobren, rezervacija_id, automobil_id, common_data_id) VALUES('Od Anna00 komentar neki ocena 5! ', true, 3, 1, 2) --za porse 911
INSERT INTO Komentar(tekst_komentara, odobren, rezervacija_id, automobil_id, common_data_id) VALUES('Od PeraCar996 Komentar neki ocena 2', true,3, 1, 3) --za porse 911

--Ocena
INSERT INTO Ocena(vredn_ocene, rezervacija_id, automobil_id, common_data_id) VALUES(4, 1, 1, 4)
INSERT INTO Ocena(vredn_ocene, rezervacija_id, automobil_id, common_data_id) VALUES(5, 1, 1, 5)
INSERT INTO Ocena(vredn_ocene, rezervacija_id, automobil_id, common_data_id) VALUES(2, 1, 1, 6)
...
--Oglas
INSERT INTO Oglas(bundle, status_rezerv, napomena_rezerv, ukupna_cena, common_data_id) VALUES(true, 'PENDING','Sve super' 22000, 10)
