...
export default {
    ...
    methods:{
      getAutomobil:function(){
        agentDataService.getAutomobil(this.id).then(response => {
          this.automobil = response.data;
        });
      },
      getAllPrices:function(){
        agentDataService.getAllCenovnik().then(response => {
      ...
      newAd:function(){
        ...
        //Apartment address
          ...
          agentDataService.addOglas(this.noviOglas).then(response => {
