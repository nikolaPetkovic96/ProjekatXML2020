    ...
    <div id="manual_reservation">
        ...
        <div class="container" id='search-result'>
            ...
            <div v-if='!isAlreadySearched'> 
                <h3><b>Brza rezervacija</b></h3>
                <h4>Unesite <b>interval</b> u kojem želite da rezervišete automobil kao i željene karakteristike </h4>
                <h4>i rezervišite <b>automobil</b> odmah...</h4>
            </div>

            <!-- Page Heading -->
            <h1 v-if='isAlreadySearched' class="my-4 theme-colr">
                <small >Rezultat pretrage</small>
            </h1>

            <div v-if='isAlreadySearched' id='sort'>
            ...
            <div class="row" >
                ...
                <div class="card h-100">
                    ...
                    <!-- <h4 class="card-title">
                        ...
                        <button v-if='isAlreadySearched' class="btn btn-outline-success margTop" v-on:click='makeReseravation(oglas.id)'> Reservisi </button>
                    </div>
                </div>
                </div>
            </div>
