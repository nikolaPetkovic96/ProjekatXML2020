        ...
        <div id='main' class='container'>
            <table class="table">
                ...
                <tr v-bind:key="rezervacija.id" v-for='rezervacija in rezervacije'>
                    ...
                    <td>
                        <button v-on:click='details(rezervacija.id)'  class="btn-outline-primary"> detalji </button>
                    </td>
                    <td>
                        <button v-on:click='editData(rezervacija.id)'  class="btn-outline-primary"> izvestaj </button>
                    </td>
                </tr>
                </tbody>
            </table>
