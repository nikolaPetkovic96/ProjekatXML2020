        ...
        <div id='main' class='container'>
            ...
            <div v-bind:key="oglas.id" v-for='oglas in rezervacija.oglasi'>
                ...
                <div id='all-messages' v-bind:key="poruka.id" v-for='poruka in rezervacija.poruke'>   
                    ...
                    <div v-if='showMessageForCar(oglas.automobil, poruka)' class='shadow btn-lg' v-bind:class="{myMessage:isMyMessage(poruka), customerMessage:isCustomerMessage(poruka)}">
                        <div id='message-text'>
                            {{poruka.tekstPoruke}}
                        </div>
...
export default {
    ...
    methods:{
        ...
        //metoda koja se koristi za filtraciju svih poruka koje su vezane za rezervaciju
        //po tome za koji su automobil vezane
        showMessageForCar(automobil, poruka){
            console.log('poruka.automobilId: ' + poruka.automobilId);
            console.log('oglas.automobil.id: ' + automobil.id)
            if(poruka.automobilId == automobil.id){
                return true;
            }
            else {
                return false;
