    ...
    <div class="row">
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            <h5 class="card-title text-center" style='color:#35424a'>Potvrda Registracije Agenta</h5>
            ...
            <div v-if='!this.submitted'>
              <form class="form-signin">
                ...
                <button type="button" class="btn btn-lg btn-primary btn-block text-uppercase" style='background-color:gold;' v-on:click='submition'>
                  Registruj se 
                </button>
                <hr class="my-4">
              </form>
